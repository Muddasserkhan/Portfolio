    ...
    <div className="loader">
      ...
      <text x="190" y="150">
        ...
        <ul className='flex sm:gap-4 gap-2 items-center justify-center'>
          <li>
            <Image src="/html-5.png" width={40} height={40} alt="Image"/>
          </li>
          <li>
            <Image src="/css-3.png" width={40} height={40} alt="Image"/>
          </li>
          <li>
            <Image src="/bootstrap.png" width={40} height={40} alt="Image"/>
          </li>
          <li>
            <Image src="/wordpress.png" width={40} height={40} className='bg-white rounded-full' alt="Image"/>
          </li>
          <li>
            <Image src="/react.png" width={40} height={40} alt="Image"/>
          </li>
        </ul>
      </div>
    </div>

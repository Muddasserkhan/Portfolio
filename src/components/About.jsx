...
const counters = [
  ...
  { targetCount: 3, title: "Years Experience" },
  { targetCount: 3, title: "Work Collaboration" },
];
...
const About = () => {
  return (
    <section className='cst_about_section sm:py-32 py-16' id="about">
        ...
        <div className="flex lg:flex-nowrap flex-wrap lg:flex-row flex-col-reverse lg:items-end lg:gap-4 gap-16 justify-between">
          <div className='lg:max-w-2xl'>
            ...
            <p className='font-medium xl:text-28 xl:leading-normal lg:text-xl lg:leading-8 ms:text-2xl text-xl text-justify leading-10'>
              I am very interested & passionate about everything related to Web Design & Development. Over 3 years of experience in the industry, I have collaborated with agencies and driven individuals to solve complex problems through innovative web development.
            </p>
